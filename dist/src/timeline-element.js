...
export let TimelineElement = TimelineElement_1 = class TimelineElement extends LitElement {
   ...
   */
    ...
    getDay(date) {
        ...
        let adjusted = DateUtil.adjustToMiddleOfDay(date, this.localeDataProvider.getTimeZone());
    ...
    prepareTimelineForDayOrWeek(interval, startDate, endDate, resBlockRegisterer) {
        ...
        let currentMonth = null;
        let currentDay = null;
        let pos = DateUtil.adjustToMiddleOfDay(startDate, this.localeDataProvider.getTimeZone());
        let end = endDate;
        let index = 0;
        let lastTimelineBlock = false;
        let date;
